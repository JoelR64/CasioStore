...
@Database(entities = {ProductoEntity.class, CarritoEntity.class, UsuarioEntity.class}, version = 1, exportSchema = false)
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            Executors.newSingleThreadExecutor().execute(() -> {
                ...
                if (database != null) {
                    ...
                    // --- 1. POBLAR PRODUCTOS (Al menos 10 ítems variados) ---
                    // Relojes
                    ...
                    // --- 2. POBLAR USUARIOS (Para el inicio de sesión) ---
